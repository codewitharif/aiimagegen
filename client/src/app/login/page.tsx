...
import { Wand2, Mail, Lock, ArrowRight, Share2, Globe, Loader2, AlertCircle } from 'lucide-react';
      ...
      >
        <div className="bg-white rounded-3xl shadow-xl border border-slate-100 p-6 sm:p-8">
          <div className="text-center space-y-3 mb-8">
            ...
            <p className="text-xs text-slate-500 font-medium px-4">Log in to your CreativeAI Studio account</p>
          </div>
          ...
          <form className="space-y-4" onSubmit={handleLogin}>
            ...
            <div className="space-y-1.5">
              <div className="flex justify-between items-center ml-1">
                ...
                <Link href="#" className="text-[10px] font-bold text-indigo-600 hover:text-indigo-700 uppercase tracking-widest">Forgot?</Link>
              </div>
              <div className="relative">
            ...
            <button 
              type="submit"
              disabled={isLoading}
              className="w-full py-3.5 bg-indigo-600 hover:bg-indigo-700 text-white rounded-2xl font-bold shadow-lg shadow-indigo-500/25 transition-all active:scale-95 flex items-center justify-center gap-2 text-sm mt-2 disabled:opacity-50"
            >
          ...
          <div className="relative my-7 text-center">
            ...
            <span className="relative px-3 bg-white text-[10px] font-bold text-slate-400 uppercase tracking-widest">Or continue with</span>
          </div>
          ...
          <p className="mt-7 text-center text-xs text-slate-500 font-medium">
            ...
            <Link href="/register" className="text-indigo-600 font-bold hover:underline">Sign up free</Link>
          </p>
        </div>
      </motion.div>
    </div>
